...
export const metadata = { title: '404 - Not Found | QuickLink' }

/** Global 404 — used by Next.js for all unmatched routes and notFound() calls. */
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-950 px-6 text-slate-100">
      <div className="w-full max-w-md rounded-2xl border border-slate-800 bg-slate-900/70 p-8 text-center shadow-2xl backdrop-blur-md">
        ...
        <h1 className="mt-4 text-2xl font-bold tracking-tight text-white">Page or Link Not Found</h1>
        <p className="mt-2 text-xs leading-relaxed text-slate-400">
          The requested path does not exist, has expired, or was removed by its creator.
        </p>
